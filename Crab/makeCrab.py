...
samples = {
	   ...
	   'SingleMuonB' : 	['data',	'/SingleMu/Run2012B-13Jul2012-v4/AOD', 			'Cert_190456-196531_8TeV_13Jul2012ReReco_Collisions12_JSON_v2.txt'],
	   'SingleMuonC' : 	['data',	'/SingleMu/Run2012C-24Aug2012-v1/AOD', 			'Cert_198022-198523_8TeV_24Aug2012ReReco_Collisions12_JSON.txt'],
	   'SingleMuonC2' : 	['data',	'',							'Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON_v2.txt'],
	   ...
	   'SingleElectronB' : 	['data',	'/SingleElectron/Run2012B-13Jul2012-v4/AOD', 		'Cert_190456-196531_8TeV_13Jul2012ReReco_Collisions12_JSON_v2.txt'],
	   ...
	   'SingleElectronC2' :	['data',	'', 							'Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON_v2.txt'],
	   ...
	   'DoubleMuonC2' : 	['data',	'', 							'Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON_v2.txt'],
	   ...
	   'DoubleElectronB' : 	['data',	'/DoubleElectron/Run2012B-13Jul2012-v4/AOD', 		'Cert_190456-196531_8TeV_13Jul2012ReReco_Collisions12_JSON_v2.txt'],
	   ...
	   'DoubleElectronC2' :	['data',	'', 							'Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON_v2.txt'],
	   ...
	   'DoubleElectronD2' :	['data',	'/DoubleElectron/Run2012D-16Jan2013-v2/AOD', 		'Cert_207883-208307_8TeV_16Jan2013ReReco_Collisions12_JSON.txt'],
	   ...
	   'T-t' :		['MC',		'/T_t-channel_TuneZ2star_8TeV-powheg-tauola/Summer12_DR53X-PU_S10_START53_V7A-v3/AODSIM'],
